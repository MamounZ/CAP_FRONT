...
export default function HowItWorks(){
	return (
		<section className="pt-32 flex flex-col items-center">
			<p className="text-7xl font-bold bg-linear-to-r from-white to-gray-400 bg-clip-text text-transparent">
				How It Works
			</p>
			<p className="max-w-2xl text-lg sm:text-xl text-gray-400 mt-8">
				Get started in minutes with our streamlined three-step process
			</p>
			<div className="my-16 grid w-full max-w-[100rem] grid-cols-1 gap-8 px-6 md:grid-cols-3">
