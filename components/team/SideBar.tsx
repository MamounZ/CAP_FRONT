...
import { X, LayoutDashboard, Users, FolderGit2, MessageSquare, Settings, type LucideIcon } from "lucide-react";
				...
				<div className="fixed top-0 left-0 min-h-full w-80 border-r border-cyan-500/50 bg-black/85">
					<div className="m-8 flex items-start justify-between">
						<div className="justify-self-center flex flex-col items-center">
							<Image
								src="/assets/CAPLogo.png"
								alt="logo"
								width={100}
								height={100}
								loading="eager"
								className="drop-shadow-[0_0_12px_rgba(34,211,238,0.55)] w-auto h-auto"
							/>
						...
						{teamTabs.map(({ label, href, icon: Icon }) => (
							<Link
								...
								className={`flex items-center gap-3 p-4 rounded-lg ${
									path === href
										? "bg-linear-to-r from-cyan-500 to-teal-500 shadow-lg shadow-cyan-500/30 text-black"
