		...
		<div className="flex flex-col gap-8">
			<div className="bg-gray-900 px-4 md:px-8 py-8 rounded-xl border border-cyan-500/50 shadow-lg shadow-cyan-500/30">
				<div className="flex flex-col items-center gap-4">
					...
					<ColoredButton onClick={()=>console.log("hi")}><div className='flex gap-4'><FileText/>Start Review</div></ColoredButton>
				</div>
			</div>
			<div>
			...
			<div>
				<div className='flex justify-between'>
					...
					<button onClick={()=> console.log("hiiiiiii")} className="text-sm text-cyan-500 hover:text-cyan-300">
						View All
					</button>
				</div>
